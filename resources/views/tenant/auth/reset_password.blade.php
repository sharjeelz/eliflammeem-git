...
<head>
    ...
    <title>Set New Password — {{ $name }}</title>
...
<div class="hidden lg:flex lg:w-5/12 xl:w-1/2 gradient-brand flex-col justify-between p-12 relative overflow-hidden">
    ...
    <div class="relative">
        ...
        <p class="text-white/70 text-base leading-relaxed max-w-sm">
            Make it strong — at least 8 characters. You'll use it to sign in from now on.
        </p>
    </div>
...
<div class="flex-1 flex flex-col justify-center items-center px-6 py-16">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-3xl shadow-2xl shadow-slate-200 border border-slate-100 p-8 sm:p-10">
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-extrabold text-slate-900 mb-1">Set New Password</h2>
            ...
            <form method="POST" action="{{ route('tenant.admin.password.update') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input id="password" type="password" name="password"
                           ...
                           class="focus-ring w-full rounded-xl border border-slate-300 bg-slate-50
                                  px-4 py-3 text-sm text-slate-900 placeholder-slate-400
                                  transition-colors @error('password') border-red-400 bg-red-50 @enderror">
                </div>
                ...
                <button type="submit"
                        class="btn-primary-custom w-full text-white font-bold text-sm py-3.5 rounded-xl shadow-lg mt-2 cursor-pointer">
                    Reset Password
                </button>
            </form>
        </div>
