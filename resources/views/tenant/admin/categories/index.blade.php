...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0"
            ...
            <h1 class="d-flex flex-column text-gray-900 fw-bold my-0 fs-1">Issue Categories</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
                <li class="breadcrumb-item text-muted"><a href="{{ url('admin') }}" class="text-muted text-hover-primary">Main</a></li>
                <li class="breadcrumb-item text-gray-900">Categories</li>
            </ul>
        </div>
        @endpush

        {{-- Filters --}}
        <form method="GET" action="{{ route('tenant.admin.categories.index') }}" class="card card-body mb-5 py-4">
            <div class="d-flex flex-wrap gap-3 align-items-end">
                ...
                <div class="d-flex gap-2 align-self-end">
                    ...
                    <a href="{{ route('tenant.admin.categories.index') }}" class="btn btn-light">Reset</a>
                </div>
        ...
        <div class="card">
            <div class="card-header border-0 pt-5 pb-0">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('tenant.admin.categories.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <a href="{{ route('tenant.admin.categories.edit', $cat) }}"
                                           class="text-gray-800 text-hover-primary fw-bold">
                                            {{ $cat->name }}
                                        </a>
                                    </div>
                                </td>
                                <td><code class="text-muted fs-8">{{ $cat->slug }}</code></td>
                                <td>
                                    @if($cat->default_sla_hours)
                                        <span class="badge badge-light-warning fw-semibold">{{ $cat->default_sla_hours }}h</span>
                                    @else
                                ...
                                <td class="text-end">
                                    ...
                                    <form method="POST" action="{{ route('tenant.admin.categories.destroy', $cat) }}"
                                          class="d-inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-10">
                                    No categories yet.
                                    <a href="{{ route('tenant.admin.categories.create') }}">Add one now</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
