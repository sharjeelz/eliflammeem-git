...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0"
            ...
            <h1 class="d-flex flex-column text-gray-900 fw-bold my-0 fs-1">Add Escalation Rule</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
                ...
                <li class="breadcrumb-item text-gray-900">Add Rule</li>
            </ul>
        </div>
        @endpush

        <form method="POST" action="{{ route('tenant.admin.escalation_rules.store') }}">
            @csrf
